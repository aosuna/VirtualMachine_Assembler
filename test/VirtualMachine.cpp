...
void VirtualMachine::load(){
	...
	if(instr.f2.I == 0){
		...
		if(instr.f2.ADDR < base || instr.f2.ADDR > limit){
			...
			cout << "load exec \n";
			cout << "reg value " << instr.f1.RD << r[instr.f1.RD] << endl;
			cout << "sr " << sr << endl;
		}
	}
	else{
...
void VirtualMachine::store(){
	...
	clock += 4;
	cout << "store exec \n";
	cout << "memory loaded " << instr.f2.RD <<  mem[instr.f2.RD] << endl;
	cout << "sr" << sr << endl;
}
...
void VirtualMachine::and_(){
	...
	cout << "and exec \n";
	cout << "reg value " << r[instr.f1.RD] << endl;
	cout << "sr" << sr << endl;
}
...
void VirtualMachine::xori(){
	...
	cout << "xori exec used f3 print f1 \n";
	cout << "reg value " << instr.f1.RD << r[instr.f1.RD] << endl;
	cout << "sr" << sr << endl;
}
